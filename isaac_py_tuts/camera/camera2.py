...
model = YOLO(r'/home/vsparekh/isaac_py_tuts/src/camera/best.pt')

results = model.predict(bgr, conf=0.25, iou=0.45, device='cuda:0')
annotated = results[0].plot()
# ==================================================================

cv2.imwrite("capture2.png", annotated)
